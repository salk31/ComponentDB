...
$ASADMIN_CMD create-jdbc-connection-pool --datasourceclassname org.mariadb.jdbc.MariaDbDataSource --restype javax.sql.DataSource --property user=${CDB_DB_USER}:password=${CDB_DB_PASSWORD}:driverClass="com.mysql.jdbc.Driver":portNumber=${CDB_DB_PORT}:databaseName=${CDB_DB_NAME}:serverName=${CDB_DB_HOST}:url="jdbc\:mysql\://${CDB_DB_HOST}\:${CDB_DB_PORT}/${CDB_DB_NAME}?zeroDateTimeBehavior\=convertToNull" ${CDB_DB_POOL}
